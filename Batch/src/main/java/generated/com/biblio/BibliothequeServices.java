...
public interface BibliothequeServices {
    ...
    @WebMethod
    @Action(input = "http://biblio.com/BibliothequeServices/listEmailClientRequest", output = "http://biblio.com/BibliothequeServices/listEmailClientResponse")
    @RequestWrapper(localName = "listEmailClient", targetNamespace = "http://biblio.com/", className = "com.biblio.ListEmailClient")
    @ResponseWrapper(localName = "listEmailClientResponse", targetNamespace = "http://biblio.com/", className = "com.biblio.ListEmailClientResponse")
    @WebResult(name = "listEmailClient", targetNamespace = "")
    public java.util.List<com.biblio.ClientResponse> listEmailClient();
}
